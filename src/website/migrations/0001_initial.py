# Generated by Django 4.2.14 on 2024-09-16 14:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linkedin_url', models.URLField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('EN ATTENTE', 'Enattente'), ('EN COURS', 'Encours'), ('TRAITÉ', 'Traite'), ('CLÔTURÉ', 'Cloture'), ('RESOLU', 'Resolved')], default='EN ATTENTE', max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
